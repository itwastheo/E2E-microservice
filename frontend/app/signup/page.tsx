    ...
    try {
      ...
      if (data.data?.token) {
        ...
        toast({
          ...
          description: "Welcome to ZenSpend.",
        })
        ...
        toast({
          title: "Account created! 🎉",
          description: "Welcome to ZenSpend. Redirecting to sign in...",
        })
      ...
      >
        ...
        <Card className="glass border-2 rounded-2xl">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>Join ZenSpend and start tracking your expenses</CardDescription>
          </CardHeader>
          <CardContent>
